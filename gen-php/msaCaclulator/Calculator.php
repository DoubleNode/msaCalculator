...
interface CalculatorIf extends \shared\SharedServiceIf {
  ...
  /**
   * @param int $logid
   * @param \msaCaclulator\Work $w
   * @return int
   * @throws \msaCaclulator\InvalidOperation
   */
  public function calculate($logid, \msaCaclulator\Work $w);
  /**
...
class CalculatorClient extends \shared\SharedServiceClient implements \msaCaclulator\CalculatorIf {
  ...
  {
    $args = new \msaCaclulator\Calculator_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCaclulator\Calculator_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCaclulator\Calculator_ping_result();
  ...
  {
    $args = new \msaCaclulator\Calculator_add_args();
    $args->num1 = $num1;
    $args->num2 = $num2;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCaclulator\Calculator_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCaclulator\Calculator_add_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
  ...
  public function send_calculate($logid, \msaCaclulator\Work $w)
  {
    $args = new \msaCaclulator\Calculator_calculate_args();
    $args->logid = $logid;
    $args->w = $w;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCaclulator\Calculator_calculate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCaclulator\Calculator_calculate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \msaCaclulator\Calculator_zip_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
...
class Calculator_calculate_result {
  ...
  public $success = null;
  /**
   * @var \msaCaclulator\InvalidOperation
   */
  public $ouch = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'ouch',
          'type' => TType::STRUCT,
          'class' => '\msaCaclulator\InvalidOperation',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->ouch = new \msaCaclulator\InvalidOperation();
