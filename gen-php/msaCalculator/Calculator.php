...
interface CalculatorIf extends \shared\SharedServiceIf {
  ...
  /**
   * @param int $logid
   * @param \msaCalculator\Work $w
   * @return int
   * @throws \msaCalculator\InvalidOperation
   */
...
class CalculatorClient extends \shared\SharedServiceClient implements \msaCalculator\CalculatorIf {
  ...
  {
    $args = new \msaCalculator\Calculator_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCalculator\Calculator_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCalculator\Calculator_ping_result();
  ...
  {
    $args = new \msaCalculator\Calculator_add_args();
    $args->num1 = $num1;
    $args->num2 = $num2;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCalculator\Calculator_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCalculator\Calculator_add_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
  ...
  public function send_calculate($logid, \msaCalculator\Work $w)
  {
    $args = new \msaCalculator\Calculator_calculate_args();
    $args->logid = $logid;
    $args->w = $w;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\msaCalculator\Calculator_calculate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \msaCalculator\Calculator_calculate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \msaCalculator\Calculator_zip_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
...
class Calculator_calculate_result {
  ...
  public $success = null;
  /**
   * @var \msaCalculator\InvalidOperation
   */
  public $ouch = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'ouch',
          'type' => TType::STRUCT,
          'class' => '\msaCalculator\InvalidOperation',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->ouch = new \msaCalculator\InvalidOperation();
...
class CalculatorProcessor extends \shared\SharedServiceProcessor {
  ...
  protected function process_calculate($seqid, $input, $output) {
    ...
    } catch (\msaCalculator\InvalidOperation $ouch) {
      $result->ouch = $ouch;
    }
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
